...
<body>
    ...
    <div class="right">
    <h1>Buying Things for the Snack Bar</h1>
...
<!-------------------------BOX WITH THE FORM===BOX1----------------->
        ...
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>?barspend">
        <table>
	 ...
	 $daily=mysql_query("INSERT INTO daily set cust_id='bar', date='$date',exp='$total',month='$month',year='$year',area='2',time='$what'")
	 or die(mysql_error());
