...
if(isset($_POST['SubmitUpdate'])) {
	...
	//historique insertion
			...
			paid='".$_POST["total$i"]."',area='2'") or die(mysql_error());
		 ...
		 // finance insertion
			...
			paid='".$_POST["total$i"]."',area='2',date='$date',month='$month',year='$year'") or die(mysql_error());
			
		//daily records
			$daily=mysql_query("INSERT INTO daily set cust_id='restau',room='".$_POST["table$i"]."',
			rec='".$_POST["total$i"]."',date='$date',month='$month',year='$year',area='2',time='$time' ") or die(mysql_error());
