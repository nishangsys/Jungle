...
<?php include 'restauhead.php'; ?>
 ...
 <div class="tables" style="width:730px; height:330px;background:#eee">
...
<table >
             ...
             <div class="name"><a href=javascript:popcontact('fpricelist.php') style="color:#1188aa; text-align:center">Click here to see all product prices</a></div>
