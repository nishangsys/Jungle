...
$month=$_POST['month'];
  ...
  <Div style="background:#1188AA; border:1PX solid#000; padding:10px 10px; width:500px; margin:20PX 20PX; float:left; color:#666; border:1px solid#000">
   ...
   <a href="?saving&date=<?PHP echo $date; ?>&area=<?PHP echo $sector; ?>&sector=<?PHP echo $s; ?>&m=<?PHP echo $month; ?>&y=<?PHP echo $year; ?>" style="color:#fff; font-size:18px; text-decoration:none">Record   <?PHP echo $s; ?> Drinks Bought on <?PHP echo $date; ?></a>
   </Div>