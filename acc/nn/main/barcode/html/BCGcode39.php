...
<!-----------start of main box---------------->
<div style="width:500px; height:250px; background:#eee; float:left; border:1px solid#000">
...
<div style="width:150px; height:150px; border:1px solid#000; float:left; background:#fff"><!-------------start Image box-------->
...
?>
                    ...
                    <div id="imageOutput">
                        ...
                        <?php if ($imageKeys['text'] !== '') { ?><img style="margin: 0 20px 20px 0;" src="image.php<?php echo $finalRequest; ?>" alt="Barcode Image" /><?php }
                         ...
                         <div style="width:500px; height:auto; color:#fff; font-family:Arial, Helvetica, sans-serif; font-weight:bold; text-transform:uppercase;
...
<?php  echo $ro['name']; ?>
                                    ...
                                    <div style="width:345px; height:220px;  float:right;"><!---------xtart the right main box-->
                                    
                                    
                                    <div style="width:345px; height:80px; background:url(include/fish.png);  border:1px solid#000">
