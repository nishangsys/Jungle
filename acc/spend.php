...
<!-------------------------BOX WITH THE FORM===BOX1----------------->
	...
	while($rows=mysql_fetch_assoc($runs)){
	 ...
	 $expense="INSERT INTO historique set date='$date',month='$month', year='$year',newdebt='$total',ayear='$ac_year',stu_id='spend' ";
	 ...
	 if($run){
			...
			echo '<meta http-equiv="Refresh" content="1; url=spend.php">';
		}
		  }
