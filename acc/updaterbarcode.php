...
<?php include 'restauhead.php'; ?>
   ...
   <form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>?good=<?php echo $all['pro_id']; ?>">
    ...
    <tr>
    	...
    	<tr>
        <td>foods</td><td><input type="text" name="product" value="<?php echo $all['product']; ?>" readonly="readonly"/></td>
        </tr>
   ...
   if(isset($_POST['update'])){
	 ...
	 $update=mysql_query("UPDATE foods set barcode='$barcode' where pro_id='$id'") or die(mysql_error());
