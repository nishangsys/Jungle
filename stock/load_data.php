...
?>
 ...
 <thead>
   ...
   <?php $d=$con->query("SELECT * FROM Warehouseorder by name  ") or die(mysqli_error($con));
$i=1;
?>
      ...
      <tr>
        ...
        <td><?php echo $df['qty']; ?></td>
         ...
         <td><?php $dd=$con->query("SELECT * FROM Warehousewhere name='".$df['name']."' ") or die(mysqli_error($con));
while($dfd=$dd->fetch_assoc()){
	echo $cp=$dfd['cost'];

	
}
	$up=$con->query("UPDATE supermkt set cost='$cp' where name='".$name."'  ") or die(mysqli_error($con));
?></td>
 ...
 <td><?php 
$dd=$con->query("SELECT * FROM Warehousewhere name='".$df['name']."' ") or die(mysqli_error($con));
while($dfd=$dd->fetch_assoc()){
	echo $sp=$dfd['sp'];

	
}
	$up=$con->query("UPDATE supermkt set sp='$sp' where name='".$df['name']."' ") or die(mysqli_error($con));
 ?></td>
...
$up=$con->query("UPDATE supermkt set barcode='$barcode' where name='".$df['name']."' ") or die(mysqli_error($con));
?>
</td>
