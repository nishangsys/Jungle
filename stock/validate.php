...
echo "<script>window.open('../stock/rec.php?roll=".$who."','_self')</script>";
		 

echo '<meta http-equiv="Refresh" stock="0; url=index.php?validate&roll=1&name=Anonymous ">';
...
<h1 style="background:#088389; text-align:center; font-size:24px; padding:20px 0px; color:#fff;"> <span style="color:#ff0"> <span style="color:#Fff"><a href="?go_ahead&link=<?php echo $name; ?>&roll=<?php echo $_GET['roll']; ?>" style="color:#Fff; text-decoration:none">Go Back to Sales |</a></span> Customer's Total Bill: 
