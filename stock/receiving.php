...
?>
      ...
      RECEIVING INTO Warehouse<span style="color:#ff0; font-weight:bold"><?PHP echo $good=$_GET['good']; ?></span> FROM <span style="color:#ff0; font-weight:bold"><?PHP echo $supp=$_GET['supp']; ?> </span>
