...
<meta http-equiv="Content-Type" stock="text/html; charset=iso-8859-1">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
       <select required class="form-control" id="sel1" name="level">
        <option value="">--------</option>
              <option value="5">Sales Man</option>
              <option value="6">Stock Controler</option>
           ...
           <td><?php  echo $i++; ?></td>
                                            ...
                                            <td><?php  echo $bu['user_name']; ?></td>
                                                     <td><?php  echo $bu['date']; ?></td>
                                                        <td>  <a href="?create_user&link=Create Users&delete=<?php echo $bu['id'];  ?>"><button type="submit" class="btn btn-danger" name="submit" onclick="return confirm('Are you sure')">Delete</button></a></td>
...
<?php
	...
	echo $delete=$_GET['delete'];
	 ...
	 echo '<meta http-equiv="Refresh" stock="0; url=?create_user&link=Create Users">';
