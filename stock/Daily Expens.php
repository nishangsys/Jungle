...
<link rel="stylesheet" type="text/css" href="../css/bootstrap.min.css">
 ...
 <div class="row">
                    <div class="col-lg-12">
                        <div class="box">
                            <header>
                                <h5>Daily Daily Expenditure Reports for <?php echo date('d-m-Y'); ?> | <a href="../stock/p_dailyEXP.php?date=<?php  echo date('d-m-Y'); ?>" style="text-decoration:none">Print a Copy <i class="icon-copy "></i></a></h5>
                                <div class="toolbar">
                                    <div class="btn-group">
