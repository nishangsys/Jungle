...
////////////////////////////
	...
	$a=$con->query("SELECT * FROM products where product='$prodc' and serial='$serial'") or die(mysqli_error($con));;
	 ...
	 echo '<meta http-equiv="Refresh" stock="0; url=add_oservices.php?roll=1&name=customer">';
...
//CHECK PRODUCT TABLE	 and update		
	$a=$con->query("SELECT * FROM products where product='$prodc' and serial='$serial'") or die(mysqli_error($con));;
	  ...
	  echo '<meta http-equiv="Refresh" stock="0; url=index.php?what=drink&area='.$_GET['area'].'&temp='.$_GET['temp'].'&tabs='.$_GET['tabs'].'">';
 ...
 <div class="form-group">
  ...
  <button type="submit" name="save" class="btn btn-success">Save Records</button>
        ...
        <div class="col-sm-5">
         ...
         <a href=javascript:popcontact('../stock/change_sales.php?tabs=<?php echo $_GET['roll']; ?>&area=0') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;">
    ...
    Validate
        ...
        <a href=javascript:popcontact('../stock/add_oservices.php?roll=<?php echo $_GET['roll']; ?>&name=<?php echo $table; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;">   
        <div class="col-sm-4" style="padding:10PX 0PX; background:#300;border:1PX solid#fff ;text-align:center; font-weight:bold;">   
