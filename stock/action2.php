...
if (!empty($items)) {
   ...
   $sql = "INSERT INTO truck (sentto,sentby,  item,stock,taken,current,discribe,date,month,year,status,receiver) VALUES  {$values} "   ;
   ...
   $branch='buea';
	...
	echo "<script>alert('SUCCESS. Stocks successfully Update')</script>";
		echo '<meta http-equiv="Refresh" content="0; url= received.php?roll&supp=general">';
