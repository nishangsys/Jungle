                ...
                <li class="panel active">
                    ...
                    <a href="?debtors&link=Our Debtors" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav" style="color:#f00; font-weight:bold">
                       <i class=" icon-folder-open-alt"></i>  Debtors  
                        ...
                        <li class="panel " >
                    <a href="?careful&link=Manipulation Reports" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav" style="font-weight:bold">
                       <i class=" icon-folder-open-alt"></i>  Manipulation Reports
