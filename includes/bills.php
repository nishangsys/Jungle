...
<script language="JavaScript" src="../content/js/pop-up.js"></script>
   ...
   <script>
	function ajax(){
		...
		req.open('GET','../supermarket/billing.php?tabs=<?php echo $table=$_GET['roll']; ?>&adds=<?php echo $_GET['adds']; ?>&reduce=<?php echo $_GET['reduce']; ?>&good=<?php echo $_GET['our_staff']; ?>&br=<?php echo $brid; ?>',true); 
		req.send();
