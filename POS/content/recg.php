<?php
echo '<meta http-equiv="Refresh" content="3; url=../cash/index.php">';
...
<div class="clear"></div>
   <div style="position:relative; font-size:12px; text-align:center; bottom:0px; height:30px">Casheir: <?php echo $who; ?><br>
...
echo '<meta http-equiv="Refresh" content="3; url=../gross/index.php">';
 ?>
