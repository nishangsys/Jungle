...
?>
 ...
 else
 {
   ...
   <td><?php echo $df['tel']; ?></td>
         ...
         <a href=javascript:popcontact('../content/pay_debts.php?adding_debtors=<?php echo $df['id']; ?>&debt=<?php echo $df['owed']; ?>&branch=<?php echo $branch; ?>&date=<?php echo $_GET['date']; ?>&month=<?php echo $_GET['month']; ?>&year=<?php echo $_GET['year']; ?>') style="color:#fff; text-decoration:blink">        											
