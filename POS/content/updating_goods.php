...
<button class="btn btn-success" ><i class="icon-edit icon-white"></i>  Update Shop Records</button>
          ...
          <a href="?smkt_whouse" >
<button class="btn btn-primary"><i class="icon-edit icon-white"></i> Update smkt_whouse Records</button>
 ...
 "></iframe>
   ...
   <div class="row">
        ...
        <div class="col-sm-12">
 <iframe src="../stock/smkt_whouse/index.php" allowFullScreen style="width: 100%;
			float:left;
			background: #FFF;
            border:none;
            height:500px;
