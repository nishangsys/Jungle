<?php
echo '<meta http-equiv="Refresh" content="2; url=../gross/index.php">';
		 ...
		 <div class="page">
		  ...
		  <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px"><?PHP echo $TEL;  ?></h1>
           <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:5px">Address: <?php echo $AD; ?></h1>
             ...
             <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px; border:1px solid#000"> WHOLESALES Receipt Num: <?PHP echo $nl;  ?> </span>
...
<div class="clear"></div>
   <div style="position:relative; font-size:12px; text-align:center; bottom:0px; height:30px">
...
echo '<meta http-equiv="Refresh" content="2; url=../gross/index.php?area='.$_GET['area'].'&roll='.$_GET['roll'].'">';
 ?>
