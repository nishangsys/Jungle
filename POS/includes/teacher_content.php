...
<button class="btn btn-success"><i class="icon-plus icon-white"></i> UPDATE smkt_whouse/ SUPER MARKET STOCK</button></a></span> | 
	...
	include '../content/reports.php';
		...
		if(isset($_GET['add_branches'])){
	include '../content/add_branches.php';
	}	
	...
	include '../stock/chose_branch123.php';
		}
		if(isset($_GET['creating_user'])){
	...
	include '../content/change_pwd.php';
		}
