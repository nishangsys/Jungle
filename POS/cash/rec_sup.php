<?php
echo '<meta http-equiv="Refresh" content="2; url=../Cash/index.php?area='.$_GET['area'].' ">';
		 ...
		 <div class="page">
          ...
          <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:5px"><?php echo $clients; ?></h1>
           ...
           <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:5px">Address: <?php echo $AD; ?></h1>
             ...
             <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px; border:1px solid#000"> SUPERMARKET Receipt Num: <?PHP echo $nl;  ?> </span>
...
echo '<meta http-equiv="Refresh" content="0; url=../cash/index.php?area='.$_GET['area'].'&roll='.$tale.'">';
 ?>
