...
?>
 ...
 <td><?php echo $df['barcode']; ?></td>
      ...
      <a href="../stock/?new=<?php echo $name=$df['id']; ?>&name=<?php echo $name=$df['name']; ?>" style="color:#000"> <button class="btn btn-success"><i class="icon-barcode icon-white"></i> Update barcode</button>
