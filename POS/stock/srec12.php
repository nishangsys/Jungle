...
$year=date('d-m-Y');
   ...
   $result=mysql_query("SELECT * from d_gross where month='$year'  ");
$O=1; 
		 ...
		 <div class="page">
          ...
          <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:5px"><?php echo $clients; ?></h1>
		   <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px">Tel:<?php echo  $TEL;  ?></h1>
		     <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px"> : <?PHP echo date('d-m-Y');  ?> Whole sale Purchases
...
<?php
$result=mysql_query("SELECT SUM(date*current) as total from d_gross where month='$year' GROUP BY month  ");
