    ...
    <a href=javascript:popcontact('../stock/adding_crditors.php') style="color:#fff; text-decoration:blink">        											<button class="btn btn-primary"><i class="icon-pencil icon-white"></i> Add A New Creditors</button></a>
