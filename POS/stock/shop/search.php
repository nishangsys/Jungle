<?php
 ...
 define('_HOST_NAME', 'localhost');
	...
	define('_DATABASE_NAME', 'super_db');
...
if(isset($_POST['search_keyword']))
{
	...
	$sqlCountries="SELECT * FROM finals WHERE name LIKE '%$search_keyword%'  ";
	...
	if($rows_returned > 0){
		while($rowCountries = $resCountries->fetch_assoc()) {		
			echo '<div class="show" align="left"><span class="country_name">'.str_ireplace($search_keyword,$bold_search_keyword,$rowCountries['name']).'</span><BR></div>'; 	
		}
	}else{
