...
if (!empty($items)) {
   ...
   $sql = "INSERT INTO d_gross (sentto,sentby,  item,stock,taken,current,discribe,date,month,year,status,receiver) VALUES  {$values} "   ;
   ...
   $branch='buea';
	...
	echo "<script>alert('SUCCESS. Stocks successfully Update')</script>";
		echo '<meta http-equiv="Refresh" content="0; url= validatethis12.php?roll&supp=general">';
