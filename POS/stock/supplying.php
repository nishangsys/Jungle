...
?>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-12" style="background:#000; color:#FFF; text-align:center; font-size:24px; color:#FF0; font-weight:bold; padding:10PX 0PX">
     SUPPLYING TO  <?php echo $branch; ?> STORE FROM MAGAZINE </span>
      <a href="received.php?roll=<?php echo $branch; ?>&supp=<?php echo $_GET['supp']; ?> "  style="color:#fff" >
...
<form method="post" action="action2.php?supp=<?php echo $branch; ?>">
