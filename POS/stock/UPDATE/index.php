...
$sql = "SELECT * FROM `smkt_whouse` order by name ";
...
<h1>UPDATING smkt_whouse STOCK</h1><br>
...
<table id="employee_grid" class="table table-condensed table-hover table-striped bootgrid-table" width="60%" style="margin-top:-50px" cellspacing="0">
   ...
   <tbody id="_editable_table">
      ...
      <tr data-row-id="<?php echo $res['id'];?>">
         ...
         <td class="editable-col" contenteditable="true" col-index='3' oldVal ="<?php echo $res['cost'];?>"><?php echo $res['cost'];?></td>
