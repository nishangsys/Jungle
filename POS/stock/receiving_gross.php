...
?>
      ...
      RECEIVING INTO GROSS SALES smkt_whouse
      <a href="validatethis12.php?roll=<?php echo $branch; ?>&supp=<?php echo $_GET['supp']; ?> "  style="color:#fff" >
...
<?php
 $sector=$_GET['supp'];
?>
<form method="post" action="action_gross.php?supp=<?php echo $sector; ?>">
