...
$message= "<div class='alert alert-success'>".$_POST['name']." Successfully Registered. Thank You</div>";
		 ...
		 echo '<meta http-equiv="Refresh" stock="0; url=?recording_services&link=Add BARBING Styles&type='.$sector.'">';
}
?>
...
if(isset($_GET['delete'])){
  ...
  $sql = $con->query("DELETE FROM hair_style where id='$id' ") or die(mysqli_error($con))   ;
		 ...
		 echo '<meta http-equiv="Refresh" stock="0; url=?recording_services&link=Add BARBING Styles&type='.$_GET['type'].' ">';
}
?>