...
$qty=$_POST['qty'];
$sp=$_POST['sp'];
$fgkl=mysql_query("SELECT * FROM smkt_whouse WHERE name ='$shape' ") or die(mysql_error());
if(mysql_num_rows($fgkl)>0){
...
$doss=$con->query("INSERT INTO supermkt SET name='$shape',disc='$disc',branch='$branch',qty='0',cost='$cost',sp='$sp'  ") or die(mysqli_error($con));
