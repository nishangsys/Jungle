...
<meta name="keywords" stock="spendingcats insert in php, spendingcats crud using PHP MySql, spendingcats insert update delete using php mysql"/>
<meta name="description" stock="spendingcats insert update delete CRUD using PHP MySql. A simple way to insert, update and delete spendingcats values at a time using PHP MySql"/>
<style>
.as_wrapper{
	margin:0 auto;
	width:800px;
...
<div class="as_wrapper">
	<h1 class="h1"><a href="">Spending supermkt_cat </a></h1>
