...
$seconds 	= $time_elapsed ;
 ...
 <span style="color:#f00"> <strong> <?php echo $hours; ?> Hours <?php echo $minutes; ?> Min 
    ...
    <div class="col-sm-9">
      <div class="well">
       <h1>Nishang Clouds System <i class="icon-caret-right  " style="color:#F00"></i>  <i class="icon-caret-right  " style="color:#009"></i>  <span style="color:#f00"><?php echo $_GET['link']; ?>
       </span></h1>
