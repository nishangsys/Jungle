...
<ul class="topnav" id="myTopnav">
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background:#060">SPLIT </button>
...
$num=1;
  ...
  <a href="?area=<?php echo $_GET['area']; ?>&open" style="color:#fff">Open Table</a>
  </li>
   ...
   <li style="background:#060">
  <a href="?what=drink&area=<?php echo $_GET['area']; ?>&tabs=<?php echo $_GET['tabs']; ?>&commands=<?php echo $_GET['tabs']; ?>" style="color:#fff">See Commands</a>
  </li>
