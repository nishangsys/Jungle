...
<td><a href="?ccontinue&nid=<?php echo $df['id']; ?>&nishangcoded"><button class="btn btn-primary"><i class="icon-cross icon-white"></i> Continue as Company Staff dresses.....</button></a></td>
