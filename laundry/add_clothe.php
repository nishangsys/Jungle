...
$df122=$con->query("DELETE FROM clothes where name='$shape' and code='$code' ") or die(mysqli_error($con));




$do=$con->query("INSERT INTO clothes SET name='$shape',code='$code'  ") or die(mysqli_error($con));
$message= "<div class='alert alert-success'>".$_POST['name']." Successfully Registered. Thank You</div>";
	echo '<meta http-equiv="Refresh" content="0; url=?add_clothe&link=Adding Clothe types">';
...
?>
  ...
  <strong>Define Prices for Single Dresses</strong> 
</div>
 ...
 <div class="form-group">
  ...
  ?>
        ...
        <div class="col-sm-12">
 <iframe src="../laundry/all_clothes.php" allowFullScreen style="width: 97%;
			float:left;
			background: #FFF;
            border:none;
            height:900px;
