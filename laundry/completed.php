...
$y=date('Y');
	$codes=$code;
	 ...
	 //////update service_offered
	    $dfkl=$con->query("UPDATE service_offered set status='3' where code='$codes' ") or die(mysqli_error($con));
  ...
  <form class="form-horizontal" action="" style="margin-top:40px" method="post" >
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-success" name="OK" onclick="return confirm('Are you sure <?php echo $name; ?> job is completed')">JOB HAVE BEEN COMPLETED BY THE DRY CLEANERS</button>
      </div>
    </div>
  </form>
