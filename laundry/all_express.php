...
<td><a href=javascript:popcontact('../laundry/completed.php?xxx=<?php echo $df['id']; ?>&owed=<?php echo $oweds; ?>&code=<?php echo $df['code']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;">  <button class="btn btn-success">
<i class="icon-cross icon-white"></i> Completed
</button></a></td>
