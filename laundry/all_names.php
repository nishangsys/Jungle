...
<td><a href="?add_clients&link=Add Clients&delete=<?php echo $df['id']; ?>"><button class="btn btn-danger"><i class="icon-cross icon-white"></i> DELETE</button></a></td>
...
if(isset($_GET['delete'])){
	 $id=$_GET['delete'];
	  $dfG=$con->query("DELETE FROM names where id='$id'") or die(mysqli_error($con));
	   ...
	   echo '<meta http-equiv="Refresh" content="0; url=all_names.php ">';
