 <div class="row">
                    <div class="col-lg-12">
                      ...
                      <?php
 $date=date('d-m-Y');
   $dm=$con->query("SELECT * FROM daily where date='$date' and area='8' and paidto='$email'   ") or die(mysqli_error($con));
   $i=1;
...
?>                     <tr>
 ...
 $date=date('d-m-Y');
   $dm=$con->query("SELECT SUM(rec),SUM(owed) FROM daily where date='$date' and paidto='$email'  GROUP BY date") or die(mysqli_error($con));
   $i=1;
while($bum=$dm->fetch_assoc()){
...
?>                     <tr>
                ...
                <td></td>
                         ...
                         <td style="background:#f00; color:#fff"><?php echo $bum['SUM(owed)']; ?></td>               </tr>
