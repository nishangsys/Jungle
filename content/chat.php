...
@session_start();
 $user=$_SESSION['user_name'];
	$a = $con->query("SELECT * FROM users where user_name='".$user."'") or die(mysqli_error($con));
...
if(isset($_POST['send'])){
 ...
 $sento=$_GET['ids'];
	...
	$mess=$_POST['comment'];
	$by=$con->query("INSERT INTO chat set name='$namse',date='$date',message='$mess',sentby=' $branch',yourid='".$ulel."',sentto='".$_GET['ids']."',date2='$date2',file='$namef',receiver='".$_GET['id']."',levels='$level'") or die(mysqli_error($con));
...
?>
              ...
              <div class="row" >
		                                ...
		                                <div class="col-md-8">
                                        <h2>Chatting with <?php echo $_GET['id']; ?> </h2>
                                        
                                        
       
               <div class="embed-responsive embed-responsive-16by9">
    <iframe class="embed-responsive-item" src="messages.php?id=<?php echo $_GET['id']; ?>&ids=<?php echo $_GET['ids']; ?>" style="height:200px; width:90% "></iframe>
</div>
