<a href="?food_cat&link=Adding Food Category">
<div class="col-sm-3" >
...
<?php
 $id;
   $dm=$con->query("SELECT * FROM food_cat") or die(mysqli_error($con));
while($bum=$dm->fetch_assoc()){
	 $deptss=$bum['name'];
     $id=$bum['id'];
?>
<a href="?adding_foods&link= <?php
echo $deptss;
?> &type=<?php echo $deptss; ?>&name=<?php echo $_GET['sect']; ?>&area=<?php echo $_GET['area']; ?>&yid=<?php echo $_GET['id']; ?>&sid=<?php echo $id; ?>&delete=<?php echo $id; ?>">
