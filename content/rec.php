...
$tale=$_GET['roll'];
  $serial;
   ...
   $result=mysql_query("SELECT product,category,SUM(qty),price,SUM(qty*price),ids from trolley where tab='".$tale."' and printed!='2' and qty>0 group by product  ");
$O=1; 
...
<?php
$result=mysql_query("SELECT SUM(price*qty) as total,tab from trolley where tab='".$tale."' and printed!='2'  GROUP BY tab  ");
...
<?php
 $first=mysql_query("UPDATE trolley set printed='2'  ") or die(mysql_error());
 ?>
