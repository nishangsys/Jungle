      			...
      			<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
                            ...
                            <td><input type="text" data-type="productCat" name="cost[]" id="cost_1" class="form-control autocomplete_txt" readonly="readonly" autocomplete="off"></td>
                            
							<td><input type="text" name="price[]" id="price_1" class="form-control changesNo" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly="readonly"></td>
							...
							<td><input type="number" name="alltotal[]" id="alltotal_1" class="form-control alltotalLinePrice" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" style="background:#f00; color:#fff" readonly="readonly"</td>
...
<?php }  ?>                
       ...
       <h3>All today's Supply <a href="printstock.php" target="_new">Print a Copy</a></h3>              
