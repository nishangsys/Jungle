...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
	<script type="text/javascript">
	    $(document).on('keyup','#paid',function(){
	    	$("#owed").val($("#totalbill").val() - $("#paid").val());
...
if(isset($_POST['SubmitUpdate'])) {
	...
	$_POST = array_map("ucwords", $_POST);
	 ...
	 $discoun=$_POST['disc'];
		...
		$acv=$con->query("INSERT INTO daily set cust_id='$who',room='',amt='$amt_owed',reason='  supermarket sales',qty='1',price='$totalbill',total='$totalbill',
			owed='',date='$date',month='$month',year='$year',area='2',time='$time',paidto='$paidto',purpose=' supermarket sales' ,idds='',discount='$discoun',staffname='$name',rec='$amount_paid',paidtou='".$_GET['name']."' ") or die(mysqli_error($con));
...
while($rt=mysql_fetch_assoc($query12)){
    ...
    ?>
            ...
            <br>
           <tr> 
            <td>Total bill</td><td>&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="totalbill" readonly class="input" onBlur="doCalc(this.form)" id="totalbill" value="<?php echo $totdebts; ?>"
                    >
                  </td></tr>
            ...
            <td>Discount</td><td>&nbsp;&nbsp&nbsp;&nbsp;&nbsp;<input type="text" name="disc"  class="input" onBlur="doCalc(this.form)" 
                  ...
                  <tr> 
            <td>Amount Paid</td><td>&nbsp;&nbsp&nbsp;&nbsp;&nbsp;<input type="text" name="paid"  class="input" onBlur="doCalc(this.form)"  id="paid"
                  required="required" value="<?php echo $totdebts; ?>"  >
                  </td></tr>
                  
                  <tr> 
            <td>Change</td><td>&nbsp;&nbsp&nbsp;&nbsp;&nbsp;<input type="text" name="owed" readonly class="input" 
                  required="required" style="background:#F00; color:#fff" id="owed" >
                  </td></tr>
