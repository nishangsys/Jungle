...
<div class="eachrec" style="  background-image: url('logos.png');
    ...
    <div class="oth" style=" height:110px; width:80%; margin:auto;  ">
    <h1 style="font-size:16px; background:#333; color:#fff"><?php echo $clients; ?> Daily Reports for <?php echo $_GET['date']; ?></h1>
    <h2><?php echo $AD ?></h2>
