...
<html>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" media="screen" href="../sales/css/left-fluid.css">
    


  <link rel="stylesheet" href="../sales/js/boostrap.css">
  <script src="../sales/js/jquery.min.js"></script>
...
@media screen and (max-width:680px) {
 ...
 <?php
   ///////////////////updat table
		  $a=mysql_query("UPDATE  bar_tables set status='1'  where num='".$_GET['tabs']."'  ") or die(mysql_error()); 
...
<br><br>
  <p> <a href="javascript:void(0);" onclick="fullScreen('../POS/Cash/index.php?roll=1&name=customer');">Access Super Market Sales Board</a></p>
  
</div>

<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
  <ul class="nav navbar-nav">
    <li class="active"><a href="#">Super Market Center</a></li>
