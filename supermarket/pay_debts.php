...
if($total<0){
 ...
 $do=$con->query("INSERT INTO daily set purpose='payment of $discribe debts ',reason='$discribe debt',day='$day',month='$month',year='$year',paidto='$user',exp='$amount',staffname='".$_GET['branch']."',date='$date'") or die(mysqli_error($con));;
