...
<div class="top-content">
	<div class="inner-bg">
                        ...
                        <?php echo $msg; ?>
							<form role="form"  method="POST" class="login-form" action="">
								<div class="form-group">
									...
									<input type="text" name="usr_email" placeholder="Enter Username...." class="form-username form-control" autocomplete="off" id="form-username" required>
								</div>
								<div class="form-group">
     ...
     <a href=javascript:popcontact('login.php') style="color:#f00; text-decoration:blink text-align:center; font-weight:bold;">   
         
    <button type="submit" class="btn btn-success btn-lg" name="doLogin" >CLICK HERE TO LOGIN </button> </a>
