 ...
 <div class="page">
      ...
      <h1 style="font-size:12px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:5px"><?php echo $clients; ?></h1>
		   <h1 style="font-size:12px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px"><?PHP echo $TEL;  ?></h1>
             ...
             <h1 style="font-size:14px; text-align:center; font-family:Arial, Helvetica, sans-serif; margin-top:-5px; border:1px solid#000"> BOND  Num: <?PHP echo $_GET['roll'];  ?> </span>
...
<div class="clear"></div>
   ...
   <th>S/N</th><th>Type</th><th>Product</th><th>Qty</th>
   
 <?php   while ($getres=$result->fetch_assoc()){ ?>
 <tr>
 	<td><?PHP echo $O++; ?></td>
    <td><?PHP  echo $getres['comment'];    ?></td>
