...
<div class="container-fluid" style="background-color:#F44336;color:#fff;height:200px;">
  ...
  <p> <a href="javascript:void(0);" onclick="fullScreen('http://192.168.1.14/nishang/POS/Cash/index.php?area=2&roll=SUP&sid=<?php echo $userid; ?>');">Confirm and Sign in as <?php echo $SECTOR; ?>  </a></p>
