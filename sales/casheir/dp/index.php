...
<input value="<?php echo $_GET['id'];?>" name="pid" type="hidden"><table>
...
if(isset($_POST['save'])){
	...
	$query_parent = mysql_query("UPDATE basket set product='$product',price='$price',qty='$nqty',total='$total' where id='".$pid."' ") or die(mysql_error());
