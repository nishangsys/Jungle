...
$year=date('d-m-Y');
   ...
   $result=mysql_query("SELECT * from disburse where month='$year'  ");
$O=1; 
...
<?php
$result=mysql_query("SELECT SUM(date*current) as total from disburse where month='$year' GROUP BY month  ");
