...
echo "<script>window.open('../content/srec.php','_new')</script>";
    ...
    ?>
            ...
            <tr>
                ...
                <td><input type="text" name="product<?php echo $i; ?>" value="<?php echo $row['stock']; ?>" class="input" required style="width:190px" readonly   /></td>
                  <td><input type="text" name="cost<?php echo $i; ?>" value="<?php $df=mysql_query("SELECT * FROM finals where name='".$row['stock']."' ") or die(mysql_error());
