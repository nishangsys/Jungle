...
$do=$con->query("INSERT INTO finals SET name='$shape',disc='$disc',branch='$branch',qty='$qty',cost='$cost',sp='$sp',sector='$sector'  ") or die(mysqli_error($con));
...
if(isset($_GET['delete'])){
  ...
  if(isset($_POST['Update'])){
	  ...
	  $Dis=$_POST['disc'];
	   ...
	   $sector=$_POST['sector'];
	 $id=$_GET['update'];
	  $dfGu=$con->query("UPDATE finals SET name='$shape',disc='$Dis',cost='$C',sp='$S',sector='$sector' where id='$id'") or die(mysqli_error($con));
	   $message= "<div class='alert alert-success'>Item Successfully Updated. Thank You</div>";
